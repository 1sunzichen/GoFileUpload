...
var file_user_proto_depIdxs = []int32{
	...
	1, // 4: go.micro.service.user.UserService.Signup:output_type -> go.micro.service.user.RespSignup
	3, // 5: go.micro.service.user.UserService.Signin:output_type -> go.micro.service.user.RespSignin
	5, // 6: go.micro.service.user.UserService.UserInfo:output_type -> go.micro.service.user.RespUserInfo
	7, // 7: go.micro.service.user.UserService.UserFiles:output_type -> go.micro.service.user.RespUserFile
